(function($) {
  ...
  const translations = {
    ...
    es: {
      ...
      projectDescriptionOne: `Un e-commerce robusto y escalable que incluye registro de usuarios, inicio de sesión, carrito de compras, resumen de la orden y barra de búsqueda, ofreciendo fluidez y eficiencia. <a href="https://bestbuymarket.netlify.app/" target="_blank">Sitio Web</a>`,
      projectDescriptionTwo: `Permite explorar el catálogo, ver información detallada de cada producto, agregar artículos al carrito y otras funciones pensadas para ofrecer una experiencia intuitiva y agradable. <a href="https://amandiva-e-commerce.vercel.app/" target="_blank" >Sitio Web</a>`,
